...
def draw_canvas():
    ...
    global MONEYYSIZE, MONEYYMARGIN, MONEYXSIZE, MONEYXMARGIN, SCOREXMARGIN, SCOREYMARGIN, SCOREXSIZE, SCOREYSIZE, \
        MXHASHESMARGIN, MXHASHESSIZE, MYHASHESSIZE, MYHASHESMARGIN, SXHASHESMARGIN, SXHASHESSIZE, SYHASHESMARGIN, SYHASHESSIZE
    ...
    if MODE == 0:
        ...
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(MXHASHESMARGIN, MYHASHESMARGIN, MXHASHESSIZE, MYHASHESSIZE)) # money hash line
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(SXHASHESMARGIN, SYHASHESMARGIN, SXHASHESSIZE, SYHASHESSIZE))  # score hash line
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(MXHASHESMARGIN, MYHASHESMARGIN, 10, 2))  # money top hash
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(MXHASHESMARGIN, 685, 10, 2))  # money middle hash
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(MXHASHESMARGIN, 818, 10, 2))  # money bottom hash
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(SXHASHESMARGIN-10, SYHASHESMARGIN, 10, 2))  # score top hash
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(SXHASHESMARGIN-10, 685, 10, 2))  # score middle hash
        pygame.draw.rect(DISPLAYSURF, (80, 0, 0), pygame.Rect(SXHASHESMARGIN-10, 818, 10, 2))  # score bottom hash
